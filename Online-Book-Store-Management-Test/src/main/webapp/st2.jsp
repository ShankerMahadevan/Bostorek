...
</label><input type="text" name="descriptionInput" id="description"
...
text-align: center;">Please enter a description</p>
     <div style="text-align: center"><label for="amount">Amount
</label><input name="amountInput" type="text" id="amount" value=""
 ><span> USD</span></div>
...
none;"><label for="invoiceid"> </label><input name="invoiceid"
...
id="paypal-button-container"></div>
   ...
   <script
src="https://www.paypal.com/sdk/js?client-id=Aa1OqyeS3r1YA4N7Ii7b5t5RW-mZuY5XNln2pYdMiybeIsRXE0wv0Sn3JYs1r6AP8jszAz5TncdVFIsm&currency=USD"
...
document.querySelector('#smart-button-container #descriptionError');
     var priceError = document.querySelector('#smart-button-container
#priceLabelError');
     var invoiceid = document.querySelector('#smart-button-container
#invoiceid');
     var invoiceidError =
document.querySelector('#smart-button-container #invoiceidError');
